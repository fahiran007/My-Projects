"""
Django settings for IntaxProject project.
...
SECRET_KEY = 'django-insecure-v=0v+4$xt0rd-vx%837x7=@u_@@-%kd+rso4n=+d$s9v27xo$h'
...
ROOT_URLCONF = 'IntaxProject.urls'
...
WSGI_APPLICATION = 'IntaxProject.wsgi.application'
